...
from airport_api.serializers import FlightDetailSerializer

FLIGHT_URL = reverse("airport-api:flight-list")
...
def detail_url(flight_id):
    return reverse("airport-api:flight-detail", args=[flight_id])
