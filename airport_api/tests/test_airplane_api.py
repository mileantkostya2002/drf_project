...
from airport_api.models import AirplaneType, Airplane
from airport_api.serializers import AirplaneListSerializer

AIRPLANE_URL = reverse("airport-api:airplane-list")
...
class AdminUserAirplaneAPITest(TestCase):
    ...
    def test_update_airplane(self):
        ...
        res = self.client.put(f"{AIRPLANE_URL}1/", {"name": "Boing 77"})
